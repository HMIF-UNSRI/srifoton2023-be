                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="product-detail-content">
                            ...
                            <a href="{{ asset('storage/'.$webdev->proof) }}" class="btn btn-sm btn-primary light mt-2 w-100 fw-medium"
                                target="blank">
                            ...
                            <div class="product-detail-content">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control mb-3" value="{{ $webdev->{"name$i"} }}"
                                            type="text" id="name1" readonly>

                                    </div>
                                    <div class="col-md-6">
                                        <label for="nim1">NIM</label>
                                        <input class="form-control mb-3" value="{{ $webdev->{"nim$i"} }}"
