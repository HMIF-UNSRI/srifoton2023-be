    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-primary fw-bold">Data Tim {{ $programming->team_name }}
                    <span
                ...
                <a href="{{ route('competition.cp') }}" class="btn btn-sm btn-primary">
                    <i class="fas fa-undo-alt me-1"></i>Back</a>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="p-3 rounded-3 border border-primary border-2 shadow-md">
                            ...
                            <img src="{{ $programming->proof }}" class="img-fluid text-center rounded-3 d-block"
                                style="max-height: 300px" id="proof" alt="">
                            <a href="{{ $programming->proof }}" class="btn btn-xs btn-primary light mt-2" target="blank">
