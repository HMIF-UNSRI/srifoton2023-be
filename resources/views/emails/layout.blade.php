...
<head>
    <title>Srifoton 2023 | @stack('title')</title>
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <a href="@stack('button-url')"
                                                                                ...
                                                                                style="box-sizing: border-box; font-size: 16px; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #3869d4; border-bottom: 8px solid #3869d4; border-left: 18px solid #3869d4; border-right: 18px solid #3869d4; border-top: 8px solid #3869d4;">@stack('button-name')</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                            ...
                                            <tr>
                                                <td style="box-sizing: border-box; position: relative;">
                                                    <p
                                                        ...
                                                        Jika anda mengalami masalah saat menekan tombol <strong>@stack('button-alias')</strong>, salin dan tempel URL ini ke web browser
                                                        anda: <span class="break-all"
                                                            style="box-sizing: border-box; position: relative; word-break: break-all;"><a
                                                                href="@stack('link-href')"
                                                                style="box-sizing: border-box; position: relative; color: #3869d4;">@stack('link-text')</a></span>
                                                    </p>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2023 Srifoton2023. All rights reserved.</p>
