...
<head>
    ...
    <title>Srifoton 2023 | Reset Password</title>
...
<body style="background-color: #edf2f7;
    ...
    <div
        ...
        <p style="font-size: 12px;">
            Jika anda mengalami masalah saat mengeklik tombol "Reset Password",
            salin dan tempel URL ini ke web browser anda: {{ $resetUrl }}
        </p>
    </div>
