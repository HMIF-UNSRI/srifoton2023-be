...
return [
     ...
     */
    'title' => 'SRIFOTON 2023 API DOCUMENTATION',

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => 'Srifoton 2023 adalah sebuah aplikasi berbasis web yang menyediakan akses ke berbagai fitur dan data melalui Apllication Programming Interface (API). API ini memungkinkan pengguna untuk melakukan operasi CRUD (Create, Read, Update, Delete) terhadap entitas yang ada di dalam sistem.',
